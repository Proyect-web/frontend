...
export function Banner({ data }: BannerProps) {
  const { banner_title, banner_subtitle, banner_image, link, banner_badge } = data;

  if (!banner_title) return null;

  return (
    <section id="ofertas" className="w-full bg-black py-12 px-4 md:pl-48 md:pr-8">
      {/* ============ CARD CONTAINER ============ */}
      <div className="container mx-auto">
        ...
        >
          ...
          {/* LÍNEA INFERIOR MEJORADA CON GLOW/SHADOW */}
          <div className="absolute bottom-15 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-cyan-400 to-transparent shadow-[0_0_15px_3px_rgba(34,211,238,0.3)]" />
          
          {/* LÍNEA DE REFUERZO CON BLUR PARA MÁS GLOW */}
          <div className="absolute bottom-15 left-1/4 right-1/4 h-[4px] bg-cyan-400/40 blur-[6px]" />
